...
const notActive =
  "w-[46px] h-[48px] flex justify-center items-center py-3 bg-white hover:bg-gray-300 rounded-md";
const active =
  "w-[46px] h-[48px] flex justify-center items-center py-3 bg-[#E13427] text-white hover:opacity-90  rounded-md";
